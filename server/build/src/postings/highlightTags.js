...
function highightTags(text) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // tags[0].text,
        'JavaScript', `<span class='${tags[0].category.color} rounded-sm p-1 w-fit text-white'>JavaScript</span>`);
...
exports.highightTags = highightTags;
//# sourceMappingURL=highlightTags.js.map