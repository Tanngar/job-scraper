...
export const scrapeLinkedInSearch = async (req, res) => {
    ...
    try {
        ...
        const noMatchResultText = await (noMatchResultElement === null || noMatchResultElement === void 0 ? void 0 : noMatchResultElement.evaluate((element) => element.textContent));
...
export const scrapeSpecificLinkedInUrl = async (req, res) => {
    const { url } = req.body;
